...
{
    public FunctionImplementationDependency(String name, TypeSignature returnType, List<TypeSignature> argumentTypes, InvocationConvention invocationConvention)
    {
